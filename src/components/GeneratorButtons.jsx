...
export default function GeneratorButtons() {
    ...
    <button id="encounter-chance-btn" onClick={handleGenClick} className="bg-blue-300 text-white py-2 px-3">
        Encounter Chance
    </button>
    <button id="encounter-gen-btn" onClick={handleGenClick} className="bg-blue-300 text-white py-2 px-3">
        Encounter Generator
    </button>
    <button id="fixture-gen-btn" onClick={handleGenClick} className="bg-blue-300 text-white py-2 px-3">
        Fixture Generator
    </button>
    </div>
}