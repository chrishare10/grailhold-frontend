...
export default function DiceRollerPanel() {
    ...
    <div className="w-full grid grid-cols-2 gap-5">
        <button id="add-dice-btn" onClick={handleDiceClick} className="bg-gColorOne hover:bg-gColorTwo text-white py-2 px-3">
            Add Dice
        </button>
        <button id="remove-dice-btn" onClick={handleDiceClick} className="bg-gColorOne hover:bg-gColorTwo text-white py-2 px-3">
            Remove Dice
        </button>
    </div>
    ...
    <button id="clear-dice-btn" onClick={handleDiceClick} className="bg-gColorOne hover:bg-gColorTwo text-white py-2 px-3">Clear Dice</button>
