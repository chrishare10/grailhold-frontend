...
export default function DiceRollerPanel() {
    ...
    <button id="dice-roll-btn" onClick={handleDiceClick} className="bg-blue-300 text-white py-2 px-3">
        Roll Dice
    </button>
    <div className="w-full grid grid-cols-2 gap-5">
        <button id="add-dice-btn" onClick={handleDiceClick} className="bg-blue-300 text-white py-2 px-3">
            Add Dice
        </button>
        <button id="remove-dice-btn" onClick={handleDiceClick} className="bg-blue-300 text-white py-2 px-3">
            Remove Dice
        </button>
    </div>
    ...
    <button id="clear-dice-btn" onClick={handleDiceClick} className="bg-blue-300 text-white py-2 px-3">Clear Dice</button>
    </div>
